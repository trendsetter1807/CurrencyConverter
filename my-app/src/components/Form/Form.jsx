...
const Form = () => {
    ...
    useEffect(() => {
        const fetchPrice = async () => {
            ...
            const baseURL = `https://v6.exchangerate-api.com/v6/a73339382d56579ad8ed25c7/latest/${fromCountry}`;
        ...
        <>
            <div className="form-body">
                ...
                <div className="bottom">
                    ...
                    <WrapItem>
                        <Button onClick={convertPrice} px={'20'} my={'5'} colorScheme='green'>Convert</Button>
                    </WrapItem>
                </div>
